...
> survey was conducted in German and no translation layer is published for the original survey data. All statistical analysis artifacts (figures and tables) in this repository appendix are however in English, matching the translated survey items as presented in the conference paper.Additionally, this README briefly describes every question block in English so the original survey data can be re-interpreted without reading German.
